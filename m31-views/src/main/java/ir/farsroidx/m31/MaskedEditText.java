...
public class MaskedEditText extends AppCompatEditText implements TextWatcher {
    ...
    public MaskedEditText(Context context, AttributeSet attrs) {
        ...
        mask = attributes.getString(R.styleable.MaskedEditText_m31_Mask);

        allowedChars = attributes.getString(R.styleable.MaskedEditText_m31_AllowedChars);
        deniedChars = attributes.getString(R.styleable.MaskedEditText_m31_DeniedChars);
        boolean enableImeAction = attributes.getBoolean(R.styleable.MaskedEditText_m31_EnableImeAction, false);

        String representation = attributes.getString(R.styleable.MaskedEditText_m31_CharRepresentation);
        ...
        keepHint = attributes.getBoolean(R.styleable.MaskedEditText_m31_KeepHint, false);

    ...
    private fun initialize(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        attrs?.let {
            ...
            context.theme.obtainStyledAttributes(
                ...
                defaultColor    = getColor(R.styleable.FlashingImageView_m31_DefaultColor, 0)
                firstColor      = getColor(R.styleable.FlashingImageView_m31_FirstColor, 0)
                secondColor     = getColor(R.styleable.FlashingImageView_m31_SecondColor, 0)
                timeChangeColor = getColor(R.styleable.FlashingImageView_m31_TimeChangeColor, 0)
                startAutoChange = getBoolean(R.styleable.FlashingImageView_m31_StartAutoChange, false)
